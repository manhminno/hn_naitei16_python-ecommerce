# Generated by Django 3.1 on 2021-08-13 04:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=254, null=True)),
                ('type', models.CharField(blank=True, choices=[('p', 'Percent'), ('d', 'Direct')], default='p', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Size',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_at', models.DateField(blank=True, default=datetime.date.today, null=True)),
                ('approve_at', models.DateField(blank=True, null=True)),
                ('phone', models.CharField(max_length=254, null=True)),
                ('address', models.CharField(max_length=254, null=True)),
                ('status', models.CharField(blank=True, choices=[('p', 'Paid'), ('n', 'Not paid'), ('w', 'waitting'), ('c', 'Cancel')], default='n', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.product')),
                ('replyComment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.comment')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
